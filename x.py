...
def attempt_login(user_id, pw):
    ...
    headers = {
        ...
        'Referer': 'https://facai988.live/bd/en/login',
        'Origin': 'https://facai988.live',
    }
    ...
    try:
        response = requests.post('https://facai988.live/api/bt/v2_1/user/login', headers=headers, json=payload, timeout=15)
